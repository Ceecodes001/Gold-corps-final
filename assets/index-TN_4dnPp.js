 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var S1;function FT(){return S1||(S1=1,(function(r){function e($,oe){var fe=$.length;$.push(oe);e:for(;0<fe;){var Ve=fe-1>>>1,D=$[Ve];if(0<o(D,oe))$[Ve]=oe,$[fe]=D,fe=Ve;else break e}}function n($){return $.length===0?null:$[0]}function s($){if($.length===0)return null;var oe=$[0],fe=$.pop();if(fe!==oe){$[0]=fe;e:for(var Ve=0,D=$.length,te=D>>>1;Ve<te;){var ce=2*(Ve+1)-1,re=$[ce],ye=ce+1,Ie=$[ye];if(0>o(re,fe))ye<D&&0>o(Ie,re)?($[Ve]=Ie,$[ye]=fe,Ve=ye):($[Ve]=re,$[ce]=fe,Ve=ce);else if(ye<D&&0>o(Ie,fe))$[Ve]=Ie,$[ye]=fe,Ve=ye;else break e}}return oe}function o($,oe){var fe=$.sortIndex-oe.sortIndex;return fe!==0?fe:$.id-oe.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var d=Date,m=d.now();r.unstable_now=function(){return d.now()-m}}var g=[],y=[],b=1,S=null,x=3,O=!1,U=!1,z=!1,q=!1,K=typeof setTimeout=="function"?setTimeout:null,ie=typeof clearTimeout=="function"?clearTimeout:null,ne=typeof setImmediate<"u"?setImmediate:null;function le($){for(var oe=n(y);oe!==null;){if(oe.callback===null)s(y);else if(oe.startTime<=$)s(y),oe.sortIndex=oe.expirationTime,e(g,oe);else break;oe=n(y)}}function se($){if(z=!1,le($),!U)if(n(g)!==null)U=!0,me||(me=!0,j());else{var oe=n(y);oe!==null&&qe(se,oe.startTime-$)}}var me=!1,V=-1,A=5,R=-1;function M(){return q?!0:!(r.unstable_now()-R<A)}function I(){if(q=!1,me){var $=r.unstable_now();R=$;var oe=!0;try{e:{U=!1,z&&(z=!1,ie(V),V=-1),O=!0;var fe=x;try{t:{for(le($),S=n(g);S!==null&&!(S.expirationTime>$&&M());){var Ve=S.callback;if(typeof Ve=="function"){S.callback=null,x=S.priorityLevel;var D=Ve(S.expirationTime<=$);if($=r.unstable_now(),typeof D=="function"){S.callback=D,le($),oe=!0;break t}S===n(g)&&s(g),le($)}else s(g);S=n(g)}if(S!==null)oe=!0;else{var te=n(y);te!==null&&qe(se,te.startTime-$),oe=!1}}break e}finally{S=null,x=fe,O=!1}oe=void 0}}finally{oe?j():me=!1}}}var j;if(typeof ne=="function")j=function(){ne(I)};else if(typeof MessageChannel<"u"){var N=new MessageChannel,rt=N.port2;N.port1.onmessage=I,j=function(){rt.postMessage(null)}}else j=function(){K(I,0)};function qe($,oe){V=K(function(){$(r.unstable_now())},oe)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function($){$.callback=null},r.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<$?Math.floor(1e3/$):5},r.unstable_getCurrentPriorityLevel=function(){return x},r.unstable_next=function($){switch(x){case 1:case 2:case 3:var oe=3;break;default:oe=x}var fe=x;x=oe;try{return $()}finally{x=fe}},r.unstable_requestPaint=function(){q=!0},r.unstable_runWithPriority=function($,oe){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var fe=x;x=$;try{return oe()}finally{x=fe}},r.unstable_scheduleCallback=function($,oe,fe){var Ve=r.unstable_now();switch(typeof fe=="object"&&fe!==null?(fe=fe.delay,fe=typeof fe=="number"&&0<fe?Ve+fe:Ve):fe=Ve,$){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=fe+D,$={id:b++,callback:oe,priorityLevel:$,startTime:fe,expirationTime:D,sortIndex:-1},fe>Ve?($.sortIndex=fe,e(y,$),n(g)===null&&$===n(y)&&(z?(ie(V),V=-1):z=!0,qe(se,fe-Ve))):($.sortIndex=D,e(g,$),U||O||(U=!0,me||(me=!0,j()))),$},r.unstable_shouldYield=M,r.unstable_wrapCallback=function($){var oe=x;return function(){var fe=x;x=oe;try{return $.apply(this,arguments)}finally{x=fe}}}})(_m)),_m}var A1;function HT(){return A1||(A1=1,vm.exports=FT()),vm.exports}var Em={exports:{}},$t={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function LS(r){oo(new Qs("platform-logger",e=>new X4(e),"PRIVATE")),oo(new Qs("heartbeat",e=>new PS(e),"PRIVATE")),Hr(zm,H1,r),Hr(zm,H1,"esm2020"),Hr("fire-js","")}LS("");function $_(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const US=$_,X_=new pc("auth","Firebase",$_());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lh(r,e,n){return`firebase:${r}:${e}:${n}`}class io{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:o,name:c}=this.auth;this.fullUserKey=lh(this.userKey,o.apiKey,c),this.fullPersistenceKey=lh("persistence",o.apiKey,c),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const n=await xh(this.auth,{idToken:e}).catch(()=>{});return n?qn._fromGetAccountInfoResponse(this.auth,n,e):null}return qn._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new io(Ki(J1),e,s);const o=(await Promise.all(n.map(async y=>{if(await y._isAvailable())return y}))).filter(y=>y);let c=o[0]||Ki(J1);const d=lh(s,e.config.apiKey,e.name);let m=null;for(const y of n)try{const b=await y._get(d);if(b){let S;if(typeof b=="string"){const x=await xh(e,{idToken:b}).catch(()=>{});if(!x)break;S=await qn._fromGetAccountInfoResponse(e,x,b)}else S=qn._fromJSON(e,b);y!==c&&(m=S),c=y;break}}catch{}const g=o.filter(y=>y._shouldAllowMigration);return!c._shouldAllowMigration||!g.length?new io(c,e,s):(c=g[0],m&&await c._set(d,m.toJSON()),await Promise.all(n.map(async y=>{if(y!==c)try{await y._remove(d)}catch{}})),new io(c,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ro(r,e){return vc(r,"POST","/v1/accounts:signInWithIdp",rr(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fi(){return window}function $A(r){fi().location.href=r}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function x2(){return typeof fi().WorkerGlobalScope<"u"&&typeof fi().importScripts=="function"}async function XA(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function WA(){return navigator?.serviceWorker?.controller||null}function ZA(){return x2()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class I2{constructor(e,n,s,o,c=!1){this.auth=e,this.resolver=s,this.user=o,this.bypassAuthState=c,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:s,postBody:o,tenantId:c,error:d,type:m}=e;if(d){this.reject(d);return}const g={auth:this.auth,requestUri:n,sessionId:s,tenantId:c||void 0,postBody:o||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(m)(g))}catch(y){this.reject(y)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return a6;case"linkViaPopup":case"linkViaRedirect":return l6;case"reauthViaPopup":case"reauthViaRedirect":return o6;default:Gn(this.auth,"internal-error")}}resolve(e){Ji(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Ji(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S6=new yc(3e4,6e4);function lv(){const r=fi().___jsl;if(r?.H){for(const e of Object.keys(r.H))if(r.H[e].r=r.H[e].r||[],r.H[e].L=r.H[e].L||[],r.H[e].r=[...r.H[e].L],r.CP)for(let n=0;n<r.CP.length;n++)r.CP[n]=null}}function A6(r){return new Promise((e,n)=>{function s(){lv(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{lv(),n(di(r,"network-request-failed"))},timeout:S6.get()})}if(fi().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(fi().gapi?.load)s();else{const o=pA("iframefcb");return fi()[o]=()=>{gapi.load?s():n(di(r,"network-request-failed"))},d2(`${mA()}?onload=${o}`).catch(c=>n(c))}}).catch(e=>{throw uh=null,e})}let uh=null;function R6(r){return uh=uh||A6(r),uh}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cm="webStorageSupport";class Y6{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=w2,this._completeRedirectFn=g6,this._overrideRedirectResult=f6}async _openPopup(e,n,s,o){Ji(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const c=await uv(e,n,s,Fm(),o);return z6(e,c,Ip())}async _openRedirect(e,n,s,o){await this._originValidation(e);const c=await uv(e,n,s,Fm(),o);return $A(c),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:o,promise:c}=this.eventManagers[n];return o?Promise.resolve(o):(Ji(c,"If manager is not set, promise should be"),c)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await P6(e),s=new v6(e);return n.register("authEvent",o=>(Ee(o?.authEvent,e,"invalid-auth-event"),{status:s.onEvent(o.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(Cm,{type:Cm},o=>{const c=o?.[0]?.[Cm];c!==void 0&&n(!!c),Gn(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=w6(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return u2()||r2()||Sp()}}const Q6=Y6;var hv="@firebase/auth",dv="1.11.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $6(r){switch(r){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function X6(r){oo(new Qs("auth",(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),c=e.getProvider("app-check-internal"),{apiKey:d,authDomain:m}=s.options;Ee(d&&!d.includes(":"),"invalid-api-key",{appName:s.name});const g={apiKey:d,authDomain:m,clientPlatform:r,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:h2(r)},y=new hA(s,o,c,g);return bA(y,n),y},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,s)=>{e.getProvider("auth-internal").initialize()})),oo(new Qs("auth-internal",e=>{const n=ts(e.getProvider("auth").getImmediate());return(s=>new K6(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Hr(hv,dv,$6(r)),Hr(hv,dv,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var D2,zl,O2,hh,Ym,M2,P2,V2;(function(){var r,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(u,v,_){return u==Array.prototype||u==Object.prototype||(u[v]=_.value),u};function n(u){u=[typeof globalThis=="object"&&globalThis,u,typeof window=="object"&&window,typeof self=="object"&&self,typeof Ju=="object"&&Ju];for(var v=0;v<u.length;++v){var _=u[v];if(_&&_.Math==Math)return _}throw Error("Cannot find global object")}var s=n(this);function o(u,v){if(v)e:{var _=s;u=u.split(".");for(var w=0;w<u.length-1;w++){var B=u[w];if(!(B in _))break e;_=_[B]}u=u[u.length-1],w=_[u],v=v(w),v!=w&&v!=null&&e(_,u,{configurable:!0,writable:!0,value:v})}}function c(u,v){u instanceof String&&(u+="");var _=0,w=!1,B={next:function(){if(!w&&_<u.length){var Q=_++;return{value:v(Q,u[Q]),done:!1}}return w=!0,{done:!0,value:void 0}}};return B[Symbol.iterator]=function(){return B},B}o("Array.prototype.values",function(u){return u||function(){return c(this,function(v,_){return _})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var d=d||{},m=this||self;function g(u){var v=typeof u;return v=v!="object"?v:u?Array.isArray(u)?"array":v:"null",v=="array"||v=="object"&&typeof u.length=="number"}function y(u){var v=typeof u;return v=="object"&&u!=null||v=="function"}function b(u,v,_){return u.call.apply(u.bind,arguments)}function S(u,v,_){if(!u)throw Error();if(2<arguments.length){var w=Array.prototype.slice.call(arguments,2);return function(){var B=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(B,w),u.apply(v,B)}}return function(){return u.apply(v,arguments)}}function x(u,v,_){return x=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?b:S,x.apply(null,arguments)}function O(u,v){var _=Array.prototype.slice.call(arguments,1);return function(){var w=_.slice();return w.push.apply(w,arguments),u.apply(this,w)}}function U(u,v){function _(){}_.prototype=v.prototype,u.aa=v.prototype,u.prototype=new _,u.prototype.constructor=u,u.Qb=function(w,B,Q){for(var ae=Array(arguments.length-2),ke=2;ke<arguments.length;ke++)ae[ke-2]=arguments[ke];return v.prototype[B].apply(w,ae)}}function z(u){const v=u.length;if(0<v){const _=Array(v);for(let w=0;w<v;w++)_[w]=u[w];return _}return[]}function q(u,v){for(let _=1;_<arguments.length;_++){const w=arguments[_];if(g(w)){const B=u.length||0,Q=w.length||0;u.length=B+Q;for(let ae=0;ae<Q;ae++)u[B+ae]=w[ae]}else u.push(w)}}class K{constructor(v,_){this.i=v,this.j=_,this.h=0,this.g=null}get(){let v;return 0<this.h?(this.h--,v=this.g,this.g=v.next,v.next=null):v=this.i(),v}}function ie(u){return/^[\s\xa0]*$/.test(u)}function ne(){var u=m.navigator;return u&&(u=u.userAgent)?u:""}function le(u){return le[" "](u),u}le[" "]=function(){};var se=ne().indexOf("Gecko")!=-1&&!(ne().toLowerCase().indexOf("webkit")!=-1&&ne().indexOf("Edge")==-1)&&!(ne().indexOf("Trident")!=-1||ne().indexOf("MSIE")!=-1)&&ne().indexOf("Edge")==-1;function me(u,v,_){for(const w in u)v.call(_,u[w],w,u)}function V(u,v){for(const _ in u)v.call(void 0,u[_],_,u)}function A(u){const v={};for(const _ in u)v[_]=u[_];return v}const R="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function M(u,v){let _,w;for(let B=1;B<arguments.length;B++){w=arguments[B];for(_ in w)u[_]=w[_];for(let Q=0;Q<R.length;Q++)_=R[Q],Object.prototype.hasOwnProperty.call(w,_)&&(u[_]=w[_])}}function I(u){var v=1;u=u.split(":");const _=[];for(;0<v&&u.length;)_.push(u.shift()),v--;return u.length&&_.push(u.join(":")),_}function j(u){m.setTimeout(()=>{throw u},0)}function N(){var u=Ve;let v=null;return u.g&&(v=u.g,u.g=u.g.next,u.g||(u.h=null),v.next=null),v}class rt{constructor(){this.h=this.g=null}add(v,_){const w=qe.get();w.set(v,_),this.h?this.h.next=w:this.g=w,this.h=w}}var qe=new K(()=>new $,u=>u.reset());class ${constructor(){this.next=this.g=this.h=null}set(v,_){this.h=v,this.g=_,this.next=null}reset(){this.next=this.g=this.h=null}}let oe,fe=!1,Ve=new rt,D=()=>{const u=m.Promise.resolve(void 0);oe=()=>{u.then(te)}};var te=()=>{for(var u;u=N();){try{u.h.call(u.g)}catch(_){j(_)}var v=qe;v.j(u),100>v.h&&(v.h++,u.next=v.g,v.g=u)}fe=!1};function ce(){this.s=this.s,this.C=this.C}ce.prototype.s=!1,ce.prototype.ma=function(){this.s||(this.s=!0,this.N())},ce.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function re(u,v){this.type=u,this.g=this.target=v,this.defaultPrevented=!1}re.prototype.h=function(){this.defaultPrevented=!0};var ye=(function(){if(!m.addEventListener||!Object.defineProperty)return!1;var u=!1,v=Object.defineProperty({},"passive",{get:function(){u=!0}});try{const _=()=>{};m.addEventListener("test",_,v),m.removeEventListener("test",_,v)}catch{}return u})();function Ie(u,v){if(re.call(this,u?u.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,u){var _=this.type=u.type,w=u.changedTouches&&u.changedTouches.length?u.changedTouches[0]:null;if(this.target=u.target||u.srcElement,this.g=v,v=u.relatedTarget){if(se){e:{try{le(v.nodeName);var B=!0;break e}catch{}B=!1}B||(v=null)}}else _=="mouseover"?v=u.fromElement:_=="mouseout"&&(v=u.toElement);this.relatedTarget=v,w?(this.clientX=w.clientX!==void 0?w.clientX:w.pageX,this.clientY=w.clientY!==void 0?w.clientY:w.pageY,this.screenX=w.screenX||0,this.screenY=w.screenY||0):(this.clientX=u.clientX!==void 0?u.clientX:u.pageX,this.clientY=u.clientY!==void 0?u.clientY:u.pageY,this.screenX=u.screenX||0,this.screenY=u.screenY||0),this.button=u.button,this.key=u.key||"",this.ctrlKey=u.ctrlKey,this.altKey=u.altKey,this.shiftKey=u.shiftKey,this.metaKey=u.metaKey,this.pointerId=u.pointerId||0,this.pointerType=typeof u.pointerType=="string"?u.pointerType:we[u.pointerType]||"",this.state=u.state,this.i=u,u.defaultPrevented&&Ie.aa.h.call(this)}}U(Ie,re);var we={2:"touch",3:"pen",4:"mouse"};Ie.prototype.h=function(){Ie.aa.h.call(this);var u=this.i;u.preventDefault?u.preventDefault():u.returnValue=!1};var Ot="closure_listenable_"+(1e6*Math.random()|0),tt=0;function Kn(u,v,_,w,B){this.listener=u,this.proxy=null,this.src=v,this.type=_,this.capture=!!w,this.ha=B,this.key=++tt,this.da=this.fa=!1}function ar(u){u.da=!0,u.listener=null,u.proxy=null,u.src=null,u.ha=null}function bi(u){this.src=u,this.g={},this.h=0}bi.prototype.add=function(u,v,_,w,B){var Q=u.toString();u=this.g[Q],u||(u=this.g[Q]=[],this.h++);var ae=ss(u,v,w,B);return-1<ae?(v=u[ae],_||(v.fa=!1)):(v=new Kn(v,this.src,Q,!!w,B),v.fa=_,u.push(v)),v};function rs(u,v){var _=v.type;if(_ in u.g){var w=u.g[_],B=Array.prototype.indexOf.call(w,v,void 0),Q;(Q=0<=B)&&Array.prototype.splice.call(w,B,1),Q&&(ar(v),u.g[_].length==0&&(delete u.g[_],u.h--))}}function ss(u,v,_,w){for(var B=0;B<u.length;++B){var Q=u[B];if(!Q.da&&Q.listener==v&&Q.capture==!!_&&Q.ha==w)return B}return-1}var as="closure_lm_"+(1e6*Math.random()|0),Ro={};function Rc(u,v,_,w,B){if(Array.isArray(v)){for(var Q=0;Q<v.length;Q++)Rc(u,v[Q],_,w,B);return null}return _=Ic(_),u&&u[Ot]?u.K(v,_,y(w)?!!w.capture:!1,B):bn(u,v,_,!1,w,B)}function bn(u,v,_,w,B,Q){if(!v)throw Error("Invalid event type");var ae=y(B)?!!B.capture:!!B,ke=sa(u);if(ke||(u[as]=ke=new bi(u)),_=ke.add(v,_,w,ae,Q),_.proxy)return _;if(w=md(),_.proxy=w,w.src=u,w.listener=_,u.addEventListener)ye||(B=ae),B===void 0&&(B=!1),u.addEventListener(v.toString(),w,B);else if(u.attachEvent)u.attachEvent(os(v.toString()),w);else if(u.addListener&&u.removeListener)u.addListener(w);else throw Error("addEventListener and attachEvent are unavailable.");return _}function md(){function u(_){return v.call(u.src,u.listener,_)}const v=pd;return u}function Io(u,v,_,w,B){if(Array.isArray(v))for(var Q=0;Q<v.length;Q++)Io(u,v[Q],_,w,B);else w=y(w)?!!w.capture:!!w,_=Ic(_),u&&u[Ot]?(u=u.i,v=String(v).toString(),v in u.g&&(Q=u.g[v],_=ss(Q,_,w,B),-1<_&&(ar(Q[_]),Array.prototype.splice.call(Q,_,1),Q.length==0&&(delete u.g[v],u.h--)))):u&&(u=sa(u))&&(v=u.g[v.toString()],u=-1,v&&(u=ss(v,_,w,B)),(_=-1<u?v[u]:null)&&ra(_))}function ra(u){if(typeof u!="number"&&u&&!u.da){var v=u.src;if(v&&v[Ot])rs(v.i,u);else{var _=u.type,w=u.proxy;v.removeEventListener?v.removeEventListener(_,w,u.capture):v.detachEvent?v.detachEvent(os(_),w):v.addListener&&v.removeListener&&v.removeListener(w),(_=sa(v))?(rs(_,u),_.h==0&&(_.src=null,v[as]=null)):ar(u)}}}function os(u){return u in Ro?Ro[u]:Ro[u]="on"+u}function pd(u,v){if(u.da)u=!0;else{v=new Ie(v,this);var _=u.listener,w=u.ha||u.src;u.fa&&ra(u),u=_.call(w,v)}return u}function sa(u){return u=u[as],u instanceof bi?u:null}var Co="__closure_events_fn_"+(1e9*Math.random()>>>0);function Ic(u){return typeof u=="function"?u:(u[Co]||(u[Co]=function(v){return u.handleEvent(v)}),u[Co])}function ut(){ce.call(this),this.i=new bi(this),this.M=this,this.F=null}U(ut,ce),ut.prototype[Ot]=!0,ut.prototype.removeEventListener=function(u,v,_,w){Io(this,u,v,_,w)};function Ge(u,v){var _,w=u.F;if(w)for(_=[];w;w=w.F)_.push(w);if(u=u.M,w=v.type||v,typeof v=="string")v=new re(v,u);else if(v instanceof re)v.target=v.target||u;else{var B=v;v=new re(w,u),M(v,B)}if(B=!0,_)for(var Q=_.length-1;0<=Q;Q--){var ae=v.g=_[Q];B=hn(ae,w,!0,v)&&B}if(ae=v.g=u,B=hn(ae,w,!0,v)&&B,B=hn(ae,w,!1,v)&&B,_)for(Q=0;Q<_.length;Q++)ae=v.g=_[Q],B=hn(ae,w,!1,v)&&B}ut.prototype.N=function(){if(ut.aa.N.call(this),this.i){var u=this.i,v;for(v in u.g){for(var _=u.g[v],w=0;w<_.length;w++)ar(_[w]);delete u.g[v],u.h--}}this.F=null},ut.prototype.K=function(u,v,_,w){return this.i.add(String(u),v,!1,_,w)},ut.prototype.L=function(u,v,_,w){return this.i.add(String(u),v,!0,_,w)};function hn(u,v,_,w){if(v=u.i.g[String(v)],!v)return!0;v=v.concat();for(var B=!0,Q=0;Q<v.length;++Q){var ae=v[Q];if(ae&&!ae.da&&ae.capture==_){var ke=ae.listener,At=ae.ha||ae.src;ae.fa&&rs(u.i,ae),B=ke.call(At,w)!==!1&&B}}return B&&!w.defaultPrevented}function Qt(u,v,_){if(typeof u=="function")_&&(u=x(u,_));else if(u&&typeof u.handleEvent=="function")u=x(u.handleEvent,u);else throw Error("Invalid listener argument");return 2147483647<Number(v)?-1:m.setTimeout(u,v||0)}function Cc(u){u.g=Qt(()=>{u.g=null,u.i&&(u.i=!1,Cc(u))},u.l);const v=u.h;u.h=null,u.m.apply(null,v)}class gd extends ce{constructor(v,_){super(),this.m=v,this.l=_,this.h=null,this.i=!1,this.g=null}j(v){this.h=arguments,this.g?this.i=!0:Cc(this)}N(){super.N(),this.g&&(m.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function ls(u){ce.call(this),this.h=u,this.g={}}U(ls,ce);var cs=[];function us(u){me(u.g,function(v,_){this.g.hasOwnProperty(_)&&ra(v)},u),u.g={}}ls.prototype.N=function(){ls.aa.N.call(this),us(this)},ls.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var kn=m.JSON.stringify,aa=m.JSON.parse,hs=class{stringify(u){return m.JSON.stringify(u,void 0)}parse(u){return m.JSON.parse(u,void 0)}};function No(){}No.prototype.h=null;function Do(u){return u.h||(u.h=u.i())}function Oo(){}var Ti={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function wi(){re.call(this,"d")}U(wi,re);function Mo(){re.call(this,"c")}U(Mo,re);var $n={},Po=null;function or(){return Po=Po||new ut}$n.La="serverreachability";function oa(u){re.call(this,$n.La,u)}U(oa,re);function lr(u){const v=or();Ge(v,new oa(v))}$n.STAT_EVENT="statevent";function Nc(u,v){re.call(this,$n.STAT_EVENT,u),this.stat=v}U(Nc,re);function st(u){const v=or();Ge(v,new Nc(v,u))}$n.Ma="timingevent";function St(u,v){re.call(this,$n.Ma,u),this.size=v}U(St,re);function vt(u,v){if(typeof u!="function")throw Error("Fn must not be null and must be a function");return m.setTimeout(function(){u()},v)}function Tn(){this.g=!0}Tn.prototype.xa=function(){this.g=!1};function Vo(u,v,_,w,B,Q){u.info(function(){if(u.g)if(Q)for(var ae="",ke=Q.split("&"),At=0;At<ke.length;At++){var je=ke[At].split("=");if(1<je.length){var Pt=je[0];je=je[1];var Rt=Pt.split("_");ae=2<=Rt.length&&Rt[1]=="type"?ae+(Pt+"="+je+"&"):ae+(Pt+"=redacted&")}}else ae=null;else ae=Q;return"XMLHTTP REQ ("+w+") [attempt "+B+"]: "+v+`
`+_+`
`+ae})}function yd(u,v,_,w,B,Q,ae){u.info(function(){return"XMLHTTP RESP ("+w+") [ attempt "+B+"]: "+v+`
`+_+`
`+Q+" "+ae})}function cr(u,v,_,w){u.info(function(){return"XMLHTTP TEXT ("+v+"): "+ds(u,_)+(w?" "+w:"")})}function Dc(u,v){u.info(function(){return"TIMEOUT: "+v})}Tn.prototype.info=function(){};function ds(u,v){if(!u.g)return v;if(!v)return null;try{var _=JSON.parse(v);if(_){for(u=0;u<_.length;u++)if(Array.isArray(_[u])){var w=_[u];if(!(2>w.length)){var B=w[1];if(Array.isArray(B)&&!(1>B.length)){var Q=B[0];if(Q!="noop"&&Q!="stop"&&Q!="close")for(var ae=1;ae<B.length;ae++)B[ae]=""}}}}return kn(_)}catch{return v}}var ur={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},xi={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Xn;function Wn(){}U(Wn,No),Wn.prototype.g=function(){return new XMLHttpRequest},Wn.prototype.i=function(){return{}},Xn=new Wn;function en(u,v,_,w){this.j=u,this.i=v,this.l=_,this.R=w||1,this.U=new ls(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new mt}function mt(){this.i=null,this.g="",this.h=!1}var ko={},la={};function jn(u,v,_){u.L=1,u.v=ys(dn(v)),u.m=_,u.P=!0,Si(u,null)}function Si(u,v){u.F=Date.now(),fs(u),u.A=dn(u.v);var _=u.A,w=u.R;Array.isArray(w)||(w=[String(w)]),qo(_.i,"t",w),u.C=0,_=u.j.J,u.h=new mt,u.g=Qc(u.j,_?v:null,!u.m),0<u.O&&(u.M=new gd(x(u.Y,u,u.g),u.O)),v=u.U,_=u.g,w=u.ca;var B="readystatechange";Array.isArray(B)||(B&&(cs[0]=B.toString()),B=cs);for(var Q=0;Q<B.length;Q++){var ae=Rc(_,B[Q],w||v.handleEvent,!1,v.h||v);if(!ae)break;v.g[ae.key]=ae}v=u.H?A(u.H):{},u.m?(u.u||(u.u="POST"),v["Content-Type"]="application/x-www-form-urlencoded",u.g.ea(u.A,u.u,u.m,v)):(u.u="GET",u.g.ea(u.A,u.u,null,v)),lr(),Vo(u.i,u.u,u.A,u.l,u.R,u.m)}en.prototype.ca=function(u){u=u.target;const v=this.M;v&&An(u)==3?v.j():this.Y(u)},en.prototype.Y=function(u){try{if(u==this.g)e:{const Rt=An(this.g);var v=this.g.Ba();const Mi=this.g.Z();if(!(3>Rt)&&(Rt!=3||this.g&&(this.h.h||this.g.oa()||Uc(this.g)))){this.J||Rt!=4||v==7||(v==8||0>=Mi?lr(3):lr(2)),hr(this);var _=this.g.Z();this.X=_;t:if(Oc(this)){var w=Uc(this.g);u="";var B=w.length,Q=An(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Ut(this),Zn(this);var ae="";break t}this.h.i=new m.TextDecoder}for(v=0;v<B;v++)this.h.h=!0,u+=this.h.i.decode(w[v],{stream:!(Q&&v==B-1)});w.length=0,this.h.g+=u,this.C=0,ae=this.h.g}else ae=this.g.oa();if(this.o=_==200,yd(this.i,this.u,this.A,this.l,this.R,Rt,_),this.o){if(this.T&&!this.K){t:{if(this.g){var ke,At=this.g;if((ke=At.g?At.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!ie(ke)){var je=ke;break t}}je=null}if(_=je)cr(this.i,this.l,_,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,ms(this,_);else{this.o=!1,this.s=3,st(12),Ut(this),Zn(this);break e}}if(this.P){_=!0;let zt;for(;!this.J&&this.C<ae.length;)if(zt=Mc(this,ae),zt==la){Rt==4&&(this.s=4,st(14),_=!1),cr(this.i,this.l,null,"[Incomplete Response]");break}else if(zt==ko){this.s=4,st(15),cr(this.i,this.l,ae,"[Invalid Chunk]"),_=!1;break}else cr(this.i,this.l,zt,null),ms(this,zt);if(Oc(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Rt!=4||ae.length!=0||this.h.h||(this.s=1,st(16),_=!1),this.o=this.o&&_,!_)cr(this.i,this.l,ae,"[Invalid Chunked Response]"),Ut(this),Zn(this);else if(0<ae.length&&!this.W){this.W=!0;var Pt=this.j;Pt.g==this&&Pt.ba&&!Pt.M&&(Pt.j.info("Great, no buffering proxy detected. Bytes received: "+ae.length),Ss(Pt),Pt.M=!0,st(11))}}else cr(this.i,this.l,ae,null),ms(this,ae);Rt==4&&Ut(this),this.o&&!this.J&&(Rt==4?Hc(this.j,this):(this.o=!1,fs(this)))}else Td(this.g),_==400&&0<ae.indexOf("Unknown SID")?(this.s=3,st(12)):(this.s=0,st(13)),Ut(this),Zn(this)}}}catch{}finally{}};function Oc(u){return u.g?u.u=="GET"&&u.L!=2&&u.j.Ca:!1}function Mc(u,v){var _=u.C,w=v.indexOf(`
`,_);return w==-1?la:(_=Number(v.substring(_,w)),isNaN(_)?ko:(w+=1,w+_>v.length?la:(v=v.slice(w,w+_),u.C=w+_,v)))}en.prototype.cancel=function(){this.J=!0,Ut(this)};function fs(u){u.S=Date.now()+u.I,Pc(u,u.I)}function Pc(u,v){if(u.B!=null)throw Error("WatchDog timer not null");u.B=vt(x(u.ba,u),v)}function hr(u){u.B&&(m.clearTimeout(u.B),u.B=null)}en.prototype.ba=function(){this.B=null;const u=Date.now();0<=u-this.S?(Dc(this.i,this.A),this.L!=2&&(lr(),st(17)),Ut(this),this.s=2,Zn(this)):Pc(this,this.S-u)};function Zn(u){u.j.G==0||u.J||Hc(u.j,u)}function Ut(u){hr(u);var v=u.M;v&&typeof v.ma=="function"&&v.ma(),u.M=null,us(u.U),u.g&&(v=u.g,u.g=null,v.abort(),v.ma())}function ms(u,v){try{var _=u.j;if(_.G!=0&&(_.g==u||jo(_.h,u))){if(!u.K&&jo(_.h,u)&&_.G==3){try{var w=_.Da.g.parse(v)}catch{w=null}if(Array.isArray(w)&&w.length==3){var B=w;if(B[0]==0){e:if(!_.u){if(_.g)if(_.g.F+3e3<u.F)Ea(_),va(_);else break e;Qo(_),st(18)}}else _.za=B[1],0<_.za-_.T&&37500>B[2]&&_.F&&_.v==0&&!_.C&&(_.C=vt(x(_.Za,_),6e3));if(1>=ua(_.h)&&_.ca){try{_.ca()}catch{}_.ca=void 0}}else Oi(_,11)}else if((u.K||_.g==u)&&Ea(_),!ie(v))for(B=_.Da.g.parse(v),v=0;v<B.length;v++){let je=B[v];if(_.T=je[0],je=je[1],_.G==2)if(je[0]=="c"){_.K=je[1],_.ia=je[2];const Pt=je[3];Pt!=null&&(_.la=Pt,_.j.info("VER="+_.la));const Rt=je[4];Rt!=null&&(_.Aa=Rt,_.j.info("SVER="+_.Aa));const Mi=je[5];Mi!=null&&typeof Mi=="number"&&0<Mi&&(w=1.5*Mi,_.L=w,_.j.info("backChannelRequestTimeoutMs_="+w)),w=_;const zt=u.g;if(zt){const si=zt.g?zt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(si){var Q=w.h;Q.g||si.indexOf("spdy")==-1&&si.indexOf("quic")==-1&&si.indexOf("h2")==-1||(Q.j=Q.l,Q.g=new Set,Q.h&&(ha(Q,Q.h),Q.h=null))}if(w.D){const $o=zt.g?zt.g.getResponseHeader("X-HTTP-Session-Id"):null;$o&&(w.ya=$o,Ke(w.I,w.D,$o))}}_.G=3,_.l&&_.l.ua(),_.ba&&(_.R=Date.now()-u.F,_.j.info("Handshake RTT: "+_.R+"ms")),w=_;var ae=u;if(w.qa=Yc(w,w.J?w.ia:null,w.W),ae.K){tn(w.h,ae);var ke=ae,At=w.L;At&&(ke.I=At),ke.B&&(hr(ke),fs(ke)),w.g=ae}else qc(w);0<_.i.length&&_a(_)}else je[0]!="stop"&&je[0]!="close"||Oi(_,7);else _.G==3&&(je[0]=="stop"||je[0]=="close"?je[0]=="stop"?Oi(_,7):Go(_):je[0]!="noop"&&_.l&&_.l.ta(je),_.v=0)}}lr(4)}catch{}}var Vc=class{constructor(u,v){this.g=u,this.map=v}};function Ai(u){this.l=u||10,m.PerformanceNavigationTiming?(u=m.performance.getEntriesByType("navigation"),u=0<u.length&&(u[0].nextHopProtocol=="hq"||u[0].nextHopProtocol=="h2")):u=!!(m.chrome&&m.chrome.loadTimes&&m.chrome.loadTimes()&&m.chrome.loadTimes().wasFetchedViaSpdy),this.j=u?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function ca(u){return u.h?!0:u.g?u.g.size>=u.j:!1}function ua(u){return u.h?1:u.g?u.g.size:0}function jo(u,v){return u.h?u.h==v:u.g?u.g.has(v):!1}function ha(u,v){u.g?u.g.add(v):u.h=v}function tn(u,v){u.h&&u.h==v?u.h=null:u.g&&u.g.has(v)&&u.g.delete(v)}Ai.prototype.cancel=function(){if(this.i=Lo(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const u of this.g.values())u.cancel();this.g.clear()}};function Lo(u){if(u.h!=null)return u.i.concat(u.h.D);if(u.g!=null&&u.g.size!==0){let v=u.i;for(const _ of u.g.values())v=v.concat(_.D);return v}return z(u.i)}function vd(u){if(u.V&&typeof u.V=="function")return u.V();if(typeof Map<"u"&&u instanceof Map||typeof Set<"u"&&u instanceof Set)return Array.from(u.values());if(typeof u=="string")return u.split("");if(g(u)){for(var v=[],_=u.length,w=0;w<_;w++)v.push(u[w]);return v}v=[],_=0;for(w in u)v[_++]=u[w];return v}function da(u){if(u.na&&typeof u.na=="function")return u.na();if(!u.V||typeof u.V!="function"){if(typeof Map<"u"&&u instanceof Map)return Array.from(u.keys());if(!(typeof Set<"u"&&u instanceof Set)){if(g(u)||typeof u=="string"){var v=[];u=u.length;for(var _=0;_<u;_++)v.push(_);return v}v=[],_=0;for(const w in u)v[_++]=w;return v}}}function Uo(u,v){if(u.forEach&&typeof u.forEach=="function")u.forEach(v,void 0);else if(g(u)||typeof u=="string")Array.prototype.forEach.call(u,v,void 0);else for(var _=da(u),w=vd(u),B=w.length,Q=0;Q<B;Q++)v.call(void 0,w[Q],_&&_[Q],u)}var ps=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function _d(u,v){if(u){u=u.split("&");for(var _=0;_<u.length;_++){var w=u[_].indexOf("="),B=null;if(0<=w){var Q=u[_].substring(0,w);B=u[_].substring(w+1)}else Q=u[_];v(Q,B?decodeURIComponent(B.replace(/\+/g," ")):"")}}}function _t(u){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,u instanceof _t){this.h=u.h,gs(this,u.j),this.o=u.o,this.g=u.g,dr(this,u.s),this.l=u.l;var v=u.i,_=new Ii;_.i=v.i,v.g&&(_.g=new Map(v.g),_.h=v.h),Ri(this,_),this.m=u.m}else u&&(v=String(u).match(ps))?(this.h=!1,gs(this,v[1]||"",!0),this.o=wn(v[2]||""),this.g=wn(v[3]||"",!0),dr(this,v[4]),this.l=wn(v[5]||"",!0),Ri(this,v[6]||"",!0),this.m=wn(v[7]||"")):(this.h=!1,this.i=new Ii(null,this.h))}_t.prototype.toString=function(){var u=[],v=this.j;v&&u.push(vs(v,zo,!0),":");var _=this.g;return(_||v=="file")&&(u.push("//"),(v=this.o)&&u.push(vs(v,zo,!0),"@"),u.push(encodeURIComponent(String(_)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),_=this.s,_!=null&&u.push(":",String(_))),(_=this.l)&&(this.g&&_.charAt(0)!="/"&&u.push("/"),u.push(vs(_,_.charAt(0)=="/"?Ed:Bo,!0))),(_=this.i.toString())&&u.push("?",_),(_=this.m)&&u.push("#",vs(_,fa)),u.join("")};function dn(u){return new _t(u)}function gs(u,v,_){u.j=_?wn(v,!0):v,u.j&&(u.j=u.j.replace(/:$/,""))}function dr(u,v){if(v){if(v=Number(v),isNaN(v)||0>v)throw Error("Bad port number "+v);u.s=v}else u.s=null}function Ri(u,v,_){v instanceof Ii?(u.i=v,jc(u.i,u.h)):(_||(v=vs(v,bd)),u.i=new Ii(v,u.h))}function Ke(u,v,_){u.i.set(v,_)}function ys(u){return Ke(u,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),u}function wn(u,v){return u?v?decodeURI(u.replace(/%25/g,"%2525")):decodeURIComponent(u):""}function vs(u,v,_){return typeof u=="string"?(u=encodeURI(u).replace(v,kc),_&&(u=u.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),u):null}function kc(u){return u=u.charCodeAt(0),"%"+(u>>4&15).toString(16)+(u&15).toString(16)}var zo=/[#\/\?@]/g,Bo=/[#\?:]/g,Ed=/[#\?]/g,bd=/[#\?@]/g,fa=/#/g;function Ii(u,v){this.h=this.g=null,this.i=u||null,this.j=!!v}function xn(u){u.g||(u.g=new Map,u.h=0,u.i&&_d(u.i,function(v,_){u.add(decodeURIComponent(v.replace(/\+/g," ")),_)}))}r=Ii.prototype,r.add=function(u,v){xn(this),this.i=null,u=Jn(this,u);var _=this.g.get(u);return _||this.g.set(u,_=[]),_.push(v),this.h+=1,this};function Ci(u,v){xn(u),v=Jn(u,v),u.g.has(v)&&(u.i=null,u.h-=u.g.get(v).length,u.g.delete(v))}function Ni(u,v){return xn(u),v=Jn(u,v),u.g.has(v)}r.forEach=function(u,v){xn(this),this.g.forEach(function(_,w){_.forEach(function(B){u.call(v,B,w,this)},this)},this)},r.na=function(){xn(this);const u=Array.from(this.g.values()),v=Array.from(this.g.keys()),_=[];for(let w=0;w<v.length;w++){const B=u[w];for(let Q=0;Q<B.length;Q++)_.push(v[w])}return _},r.V=function(u){xn(this);let v=[];if(typeof u=="string")Ni(this,u)&&(v=v.concat(this.g.get(Jn(this,u))));else{u=Array.from(this.g.values());for(let _=0;_<u.length;_++)v=v.concat(u[_])}return v},r.set=function(u,v){return xn(this),this.i=null,u=Jn(this,u),Ni(this,u)&&(this.h-=this.g.get(u).length),this.g.set(u,[v]),this.h+=1,this},r.get=function(u,v){return u?(u=this.V(u),0<u.length?String(u[0]):v):v};function qo(u,v,_){Ci(u,v),0<_.length&&(u.i=null,u.g.set(Jn(u,v),z(_)),u.h+=_.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const u=[],v=Array.from(this.g.keys());for(var _=0;_<v.length;_++){var w=v[_];const Q=encodeURIComponent(String(w)),ae=this.V(w);for(w=0;w<ae.length;w++){var B=Q;ae[w]!==""&&(B+="="+encodeURIComponent(String(ae[w]))),u.push(B)}}return this.i=u.join("&")};function Jn(u,v){return v=String(v),u.j&&(v=v.toLowerCase()),v}function jc(u,v){v&&!u.j&&(xn(u),u.i=null,u.g.forEach(function(_,w){var B=w.toLowerCase();w!=B&&(Ci(this,w),qo(this,B,_))},u)),u.j=v}function _s(u,v){const _=new Tn;if(m.Image){const w=new Image;w.onload=O(Sn,_,"TestLoadImage: loaded",!0,v,w),w.onerror=O(Sn,_,"TestLoadImage: error",!1,v,w),w.onabort=O(Sn,_,"TestLoadImage: abort",!1,v,w),w.ontimeout=O(Sn,_,"TestLoadImage: timeout",!1,v,w),m.setTimeout(function(){w.ontimeout&&w.ontimeout()},1e4),w.src=u}else v(!1)}function Ln(u,v){const _=new Tn,w=new AbortController,B=setTimeout(()=>{w.abort(),Sn(_,"TestPingServer: timeout",!1,v)},1e4);fetch(u,{signal:w.signal}).then(Q=>{clearTimeout(B),Q.ok?Sn(_,"TestPingServer: ok",!0,v):Sn(_,"TestPingServer: server error",!1,v)}).catch(()=>{clearTimeout(B),Sn(_,"TestPingServer: error",!1,v)})}function Sn(u,v,_,w,B){try{B&&(B.onload=null,B.onerror=null,B.onabort=null,B.ontimeout=null),w(_)}catch{}}function Es(){this.g=new hs}function ei(u,v,_){const w=_||"";try{Uo(u,function(B,Q){let ae=B;y(B)&&(ae=kn(B)),v.push(w+Q+"="+encodeURIComponent(ae))})}catch(B){throw v.push(w+"type="+encodeURIComponent("_badmap")),B}}function fr(u){this.l=u.Ub||null,this.j=u.eb||!1}U(fr,No),fr.prototype.g=function(){return new Di(this.l,this.j)},fr.prototype.i=(function(u){return function(){return u}})({});function Di(u,v){ut.call(this),this.D=u,this.o=v,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}U(Di,ut),r=Di.prototype,r.open=function(u,v){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=u,this.A=v,this.readyState=1,ni(this)},r.send=function(u){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const v={headers:this.u,method:this.B,credentials:this.m,cache:void 0};u&&(v.body=u),(this.D||m).fetch(new Request(this.A,v)).then(this.Sa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,ti(this)),this.readyState=0},r.Sa=function(u){if(this.g&&(this.l=u,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=u.headers,this.readyState=2,ni(this)),this.g&&(this.readyState=3,ni(this),this.g)))if(this.responseType==="arraybuffer")u.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof m.ReadableStream<"u"&&"body"in u){if(this.j=u.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Fo(this)}else u.text().then(this.Ra.bind(this),this.ga.bind(this))};function Fo(u){u.j.read().then(u.Pa.bind(u)).catch(u.ga.bind(u))}r.Pa=function(u){if(this.g){if(this.o&&u.value)this.response.push(u.value);else if(!this.o){var v=u.value?u.value:new Uint8Array(0);(v=this.v.decode(v,{stream:!u.done}))&&(this.response=this.responseText+=v)}u.done?ti(this):ni(this),this.readyState==3&&Fo(this)}},r.Ra=function(u){this.g&&(this.response=this.responseText=u,ti(this))},r.Qa=function(u){this.g&&(this.response=u,ti(this))},r.ga=function(){this.g&&ti(this)};function ti(u){u.readyState=4,u.l=null,u.j=null,u.v=null,ni(u)}r.setRequestHeader=function(u,v){this.u.append(u,v)},r.getResponseHeader=function(u){return this.h&&this.h.get(u.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const u=[],v=this.h.entries();for(var _=v.next();!_.done;)_=_.value,u.push(_[0]+": "+_[1]),_=v.next();return u.join(`\r
`)};function ni(u){u.onreadystatechange&&u.onreadystatechange.call(u)}Object.defineProperty(Di.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(u){this.m=u?"include":"same-origin"}});function Ho(u){let v="";return me(u,function(_,w){v+=w,v+=":",v+=_,v+=`\r
`}),v}function Mt(u,v,_){e:{for(w in _){var w=!1;break e}w=!0}w||(_=Ho(_),typeof u=="string"?_!=null&&encodeURIComponent(String(_)):Ke(u,v,_))}function Fe(u){ut.call(this),this.headers=new Map,this.o=u||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}U(Fe,ut);var ma=/^https?$/i,bs=["POST","PUT"];r=Fe.prototype,r.Ha=function(u){this.J=u},r.ea=function(u,v,_,w){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+u);v=v?v.toUpperCase():"GET",this.D=u,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Xn.g(),this.v=this.o?Do(this.o):Do(Xn),this.g.onreadystatechange=x(this.Ea,this);try{this.B=!0,this.g.open(v,String(u),!0),this.B=!1}catch(Q){Lc(this,Q);return}if(u=_||"",_=new Map(this.headers),w)if(Object.getPrototypeOf(w)===Object.prototype)for(var B in w)_.set(B,w[B]);else if(typeof w.keys=="function"&&typeof w.get=="function")for(const Q of w.keys())_.set(Q,w.get(Q));else throw Error("Unknown input type for opt_headers: "+String(w));w=Array.from(_.keys()).find(Q=>Q.toLowerCase()=="content-type"),B=m.FormData&&u instanceof m.FormData,!(0<=Array.prototype.indexOf.call(bs,v,void 0))||w||B||_.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[Q,ae]of _)this.g.setRequestHeader(Q,ae);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Ts(this),this.u=!0,this.g.send(u),this.u=!1}catch(Q){Lc(this,Q)}};function Lc(u,v){u.h=!1,u.g&&(u.j=!0,u.g.abort(),u.j=!1),u.l=v,u.m=5,pa(u),ii(u)}function pa(u){u.A||(u.A=!0,Ge(u,"complete"),Ge(u,"error"))}r.abort=function(u){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=u||7,Ge(this,"complete"),Ge(this,"abort"),ii(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ii(this,!0)),Fe.aa.N.call(this)},r.Ea=function(){this.s||(this.B||this.u||this.j?ga(this):this.bb())},r.bb=function(){ga(this)};function ga(u){if(u.h&&typeof d<"u"&&(!u.v[1]||An(u)!=4||u.Z()!=2)){if(u.u&&An(u)==4)Qt(u.Ea,0,u);else if(Ge(u,"readystatechange"),An(u)==4){u.h=!1;try{const ae=u.Z();e:switch(ae){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var v=!0;break e;default:v=!1}var _;if(!(_=v)){var w;if(w=ae===0){var B=String(u.D).match(ps)[1]||null;!B&&m.self&&m.self.location&&(B=m.self.location.protocol.slice(0,-1)),w=!ma.test(B?B.toLowerCase():"")}_=w}if(_)Ge(u,"complete"),Ge(u,"success");else{u.m=6;try{var Q=2<An(u)?u.g.statusText:""}catch{Q=""}u.l=Q+" ["+u.Z()+"]",pa(u)}}finally{ii(u)}}}}function ii(u,v){if(u.g){Ts(u);const _=u.g,w=u.v[0]?()=>{}:null;u.g=null,u.v=null,v||Ge(u,"ready");try{_.onreadystatechange=w}catch{}}}function Ts(u){u.I&&(m.clearTimeout(u.I),u.I=null)}r.isActive=function(){return!!this.g};function An(u){return u.g?u.g.readyState:0}r.Z=function(){try{return 2<An(this)?this.g.status:-1}catch{return-1}},r.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.Oa=function(u){if(this.g){var v=this.g.responseText;return u&&v.indexOf(u)==0&&(v=v.substring(u.length)),aa(v)}};function Uc(u){try{if(!u.g)return null;if("response"in u.g)return u.g.response;switch(u.H){case"":case"text":return u.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in u.g)return u.g.mozResponseArrayBuffer}return null}catch{return null}}function Td(u){const v={};u=(u.g&&2<=An(u)&&u.g.getAllResponseHeaders()||"").split(`\r
`);for(let w=0;w<u.length;w++){if(ie(u[w]))continue;var _=I(u[w]);const B=_[0];if(_=_[1],typeof _!="string")continue;_=_.trim();const Q=v[B]||[];v[B]=Q,Q.push(_)}V(v,function(w){return w.join(", ")})}r.Ba=function(){return this.m},r.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function ws(u,v,_){return _&&_.internalChannelParams&&_.internalChannelParams[u]||v}function ya(u){this.Aa=0,this.i=[],this.j=new Tn,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=ws("failFast",!1,u),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=ws("baseRetryDelayMs",5e3,u),this.cb=ws("retryDelaySeedMs",1e4,u),this.Wa=ws("forwardChannelMaxRetries",2,u),this.wa=ws("forwardChannelRequestTimeoutMs",2e4,u),this.pa=u&&u.xmlHttpFactory||void 0,this.Xa=u&&u.Tb||void 0,this.Ca=u&&u.useFetchStreams||!1,this.L=void 0,this.J=u&&u.supportsCrossDomainXhr||!1,this.K="",this.h=new Ai(u&&u.concurrentRequestLimit),this.Da=new Es,this.P=u&&u.fastHandshake||!1,this.O=u&&u.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=u&&u.Rb||!1,u&&u.xa&&this.j.xa(),u&&u.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&u&&u.detectBufferingProxy||!1,this.ja=void 0,u&&u.longPollingTimeout&&0<u.longPollingTimeout&&(this.ja=u.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}r=ya.prototype,r.la=8,r.G=1,r.connect=function(u,v,_,w){st(0),this.W=u,this.H=v||{},_&&w!==void 0&&(this.H.OSID=_,this.H.OAID=w),this.F=this.X,this.I=Yc(this,null,this.W),_a(this)};function Go(u){if(zc(u),u.G==3){var v=u.U++,_=dn(u.I);if(Ke(_,"SID",u.K),Ke(_,"RID",v),Ke(_,"TYPE","terminate"),xs(u,_),v=new en(u,u.j,v),v.L=2,v.v=ys(dn(_)),_=!1,m.navigator&&m.navigator.sendBeacon)try{_=m.navigator.sendBeacon(v.v.toString(),"")}catch{}!_&&m.Image&&(new Image().src=v.v,_=!0),_||(v.g=Qc(v.j,null),v.g.ea(v.v)),v.F=Date.now(),fs(v)}Gc(u)}function va(u){u.g&&(Ss(u),u.g.cancel(),u.g=null)}function zc(u){va(u),u.u&&(m.clearTimeout(u.u),u.u=null),Ea(u),u.h.cancel(),u.s&&(typeof u.s=="number"&&m.clearTimeout(u.s),u.s=null)}function _a(u){if(!ca(u.h)&&!u.s){u.s=!0;var v=u.Ga;oe||D(),fe||(oe(),fe=!0),Ve.add(v,u),u.B=0}}function wd(u,v){return ua(u.h)>=u.h.j-(u.s?1:0)?!1:u.s?(u.i=v.D.concat(u.i),!0):u.G==1||u.G==2||u.B>=(u.Va?0:u.Wa)?!1:(u.s=vt(x(u.Ga,u,v),Ko(u,u.B)),u.B++,!0)}r.Ga=function(u){if(this.s)if(this.s=null,this.G==1){if(!u){this.U=Math.floor(1e5*Math.random()),u=this.U++;const B=new en(this,this.j,u);let Q=this.o;if(this.S&&(Q?(Q=A(Q),M(Q,this.S)):Q=this.S),this.m!==null||this.O||(B.H=Q,Q=null),this.P)e:{for(var v=0,_=0;_<this.i.length;_++){t:{var w=this.i[_];if("__data__"in w.map&&(w=w.map.__data__,typeof w=="string")){w=w.length;break t}w=void 0}if(w===void 0)break;if(v+=w,4096<v){v=_;break e}if(v===4096||_===this.i.length-1){v=_+1;break e}}v=1e3}else v=1e3;v=Bc(this,B,v),_=dn(this.I),Ke(_,"RID",u),Ke(_,"CVER",22),this.D&&Ke(_,"X-HTTP-Session-Id",this.D),xs(this,_),Q&&(this.O?v="headers="+encodeURIComponent(String(Ho(Q)))+"&"+v:this.m&&Mt(_,this.m,Q)),ha(this.h,B),this.Ua&&Ke(_,"TYPE","init"),this.P?(Ke(_,"$req",v),Ke(_,"SID","null"),B.T=!0,jn(B,_,null)):jn(B,_,v),this.G=2}}else this.G==3&&(u?Yo(this,u):this.i.length==0||ca(this.h)||Yo(this))};function Yo(u,v){var _;v?_=v.l:_=u.U++;const w=dn(u.I);Ke(w,"SID",u.K),Ke(w,"RID",_),Ke(w,"AID",u.T),xs(u,w),u.m&&u.o&&Mt(w,u.m,u.o),_=new en(u,u.j,_,u.B+1),u.m===null&&(_.H=u.o),v&&(u.i=v.D.concat(u.i)),v=Bc(u,_,1e3),_.I=Math.round(.5*u.wa)+Math.round(.5*u.wa*Math.random()),ha(u.h,_),jn(_,w,v)}function xs(u,v){u.H&&me(u.H,function(_,w){Ke(v,w,_)}),u.l&&Uo({},function(_,w){Ke(v,w,_)})}function Bc(u,v,_){_=Math.min(u.i.length,_);var w=u.l?x(u.l.Na,u.l,u):null;e:{var B=u.i;let Q=-1;for(;;){const ae=["count="+_];Q==-1?0<_?(Q=B[0].g,ae.push("ofs="+Q)):Q=0:ae.push("ofs="+Q);let ke=!0;for(let At=0;At<_;At++){let je=B[At].g;const Pt=B[At].map;if(je-=Q,0>je)Q=Math.max(0,B[At].g-100),ke=!1;else try{ei(Pt,ae,"req"+je+"_")}catch{w&&w(Pt)}}if(ke){w=ae.join("&");break e}}}return u=u.i.splice(0,_),v.D=u,w}function qc(u){if(!u.g&&!u.u){u.Y=1;var v=u.Fa;oe||D(),fe||(oe(),fe=!0),Ve.add(v,u),u.v=0}}function Qo(u){return u.g||u.u||3<=u.v?!1:(u.Y++,u.u=vt(x(u.Fa,u),Ko(u,u.v)),u.v++,!0)}r.Fa=function(){if(this.u=null,Fc(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var u=2*this.R;this.j.info("BP detection timer enabled: "+u),this.A=vt(x(this.ab,this),u)}},r.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,st(10),va(this),Fc(this))};function Ss(u){u.A!=null&&(m.clearTimeout(u.A),u.A=null)}function Fc(u){u.g=new en(u,u.j,"rpc",u.Y),u.m===null&&(u.g.H=u.o),u.g.O=0;var v=dn(u.qa);Ke(v,"RID","rpc"),Ke(v,"SID",u.K),Ke(v,"AID",u.T),Ke(v,"CI",u.F?"0":"1"),!u.F&&u.ja&&Ke(v,"TO",u.ja),Ke(v,"TYPE","xmlhttp"),xs(u,v),u.m&&u.o&&Mt(v,u.m,u.o),u.L&&(u.g.I=u.L);var _=u.g;u=u.ia,_.L=1,_.v=ys(dn(v)),_.m=null,_.P=!0,Si(_,u)}r.Za=function(){this.C!=null&&(this.C=null,va(this),Qo(this),st(19))};function Ea(u){u.C!=null&&(m.clearTimeout(u.C),u.C=null)}function Hc(u,v){var _=null;if(u.g==v){Ea(u),Ss(u),u.g=null;var w=2}else if(jo(u.h,v))_=v.D,tn(u.h,v),w=1;else return;if(u.G!=0){if(v.o)if(w==1){_=v.m?v.m.length:0,v=Date.now()-v.F;var B=u.B;w=or(),Ge(w,new St(w,_)),_a(u)}else qc(u);else if(B=v.s,B==3||B==0&&0<v.X||!(w==1&&wd(u,v)||w==2&&Qo(u)))switch(_&&0<_.length&&(v=u.h,v.i=v.i.concat(_)),B){case 1:Oi(u,5);break;case 4:Oi(u,10);break;case 3:Oi(u,6);break;default:Oi(u,2)}}}function Ko(u,v){let _=u.Ta+Math.floor(Math.random()*u.cb);return u.isActive()||(_*=2),_*v}function Oi(u,v){if(u.j.info("Error code "+v),v==2){var _=x(u.fb,u),w=u.Xa;const B=!w;w=new _t(w||"//www.google.com/images/cleardot.gif"),m.location&&m.location.protocol=="http"||gs(w,"https"),ys(w),B?_s(w.toString(),_):Ln(w.toString(),_)}else st(2);u.G=0,u.l&&u.l.sa(v),Gc(u),zc(u)}r.fb=function(u){u?(this.j.info("Successfully pinged google.com"),st(2)):(this.j.info("Failed to ping google.com"),st(1))};function Gc(u){if(u.G=0,u.ka=[],u.l){const v=Lo(u.h);(v.length!=0||u.i.length!=0)&&(q(u.ka,v),q(u.ka,u.i),u.h.i.length=0,z(u.i),u.i.length=0),u.l.ra()}}function Yc(u,v,_){var w=_ instanceof _t?dn(_):new _t(_);if(w.g!="")v&&(w.g=v+"."+w.g),dr(w,w.s);else{var B=m.location;w=B.protocol,v=v?v+"."+B.hostname:B.hostname,B=+B.port;var Q=new _t(null);w&&gs(Q,w),v&&(Q.g=v),B&&dr(Q,B),_&&(Q.l=_),w=Q}return _=u.D,v=u.ya,_&&v&&Ke(w,_,v),Ke(w,"VER",u.la),xs(u,w),w}function Qc(u,v,_){if(v&&!u.J)throw Error("Can't create secondary domain capable XhrIo object.");return v=u.Ca&&!u.pa?new Fe(new fr({eb:_})):new Fe(u.pa),v.Ha(u.J),v}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function Kc(){}r=Kc.prototype,r.ua=function(){},r.ta=function(){},r.sa=function(){},r.ra=function(){},r.isActive=function(){return!0},r.Na=function(){};function ba(){}ba.prototype.g=function(u,v){return new nn(u,v)};function nn(u,v){ut.call(this),this.g=new ya(v),this.l=u,this.h=v&&v.messageUrlParams||null,u=v&&v.messageHeaders||null,v&&v.clientProtocolHeaderRequired&&(u?u["X-Client-Protocol"]="webchannel":u={"X-Client-Protocol":"webchannel"}),this.g.o=u,u=v&&v.initMessageHeaders||null,v&&v.messageContentType&&(u?u["X-WebChannel-Content-Type"]=v.messageContentType:u={"X-WebChannel-Content-Type":v.messageContentType}),v&&v.va&&(u?u["X-WebChannel-Client-Profile"]=v.va:u={"X-WebChannel-Client-Profile":v.va}),this.g.S=u,(u=v&&v.Sb)&&!ie(u)&&(this.g.m=u),this.v=v&&v.supportsCrossDomainXhr||!1,this.u=v&&v.sendRawJson||!1,(v=v&&v.httpSessionIdParam)&&!ie(v)&&(this.g.D=v,u=this.h,u!==null&&v in u&&(u=this.h,v in u&&delete u[v])),this.j=new ri(this)}U(nn,ut),nn.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},nn.prototype.close=function(){Go(this.g)},nn.prototype.o=function(u){var v=this.g;if(typeof u=="string"){var _={};_.__data__=u,u=_}else this.u&&(_={},_.__data__=kn(u),u=_);v.i.push(new Vc(v.Ya++,u)),v.G==3&&_a(v)},nn.prototype.N=function(){this.g.l=null,delete this.j,Go(this.g),delete this.g,nn.aa.N.call(this)};function $c(u){wi.call(this),u.__headers__&&(this.headers=u.__headers__,this.statusCode=u.__status__,delete u.__headers__,delete u.__status__);var v=u.__sm__;if(v){e:{for(const _ in v){u=_;break e}u=void 0}(this.i=u)&&(u=this.i,v=v!==null&&u in v?v[u]:void 0),this.data=v}else this.data=u}U($c,wi);function Xc(){Mo.call(this),this.status=1}U(Xc,Mo);function ri(u){this.g=u}U(ri,Kc),ri.prototype.ua=function(){Ge(this.g,"a")},ri.prototype.ta=function(u){Ge(this.g,new $c(u))},ri.prototype.sa=function(u){Ge(this.g,new Xc)},ri.prototype.ra=function(){Ge(this.g,"b")},ba.prototype.createWebChannel=ba.prototype.g,nn.prototype.send=nn.prototype.o,nn.prototype.open=nn.prototype.m,nn.prototype.close=nn.prototype.close,V2=function(){return new ba},P2=function(){return or()},M2=$n,Ym={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},ur.NO_ERROR=0,ur.TIMEOUT=8,ur.HTTP_ERROR=6,hh=ur,xi.COMPLETE="complete",O2=xi,Oo.EventType=Ti,Ti.OPEN="a",Ti.CLOSE="b",Ti.ERROR="c",Ti.MESSAGE="d",ut.prototype.listen=ut.prototype.K,zl=Oo,Fe.prototype.listenOnce=Fe.prototype.L,Fe.prototype.getLastError=Fe.prototype.Ka,Fe.prototype.getLastErrorCode=Fe.prototype.Ba,Fe.prototype.getStatus=Fe.prototype.Z,Fe.prototype.getResponseJson=Fe.prototype.Oa,Fe.prototype.getResponseText=Fe.prototype.oa,Fe.prototype.send=Fe.prototype.ea,Fe.prototype.setWithCredentials=Fe.prototype.Ha,D2=Fe}).apply(typeof Ju<"u"?Ju:typeof self<"u"?self:typeof window<"u"?window:{});const pv="@firebase/firestore",gv="4.9.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xs=new _p("@firebase/firestore");function Xa(){return Xs.logLevel}function he(r,...e){if(Xs.logLevel<=Oe.DEBUG){const n=e.map(Np);Xs.debug(`Firestore (${To}): ${r}`,...n)}}function er(r,...e){if(Xs.logLevel<=Oe.ERROR){const n=e.map(Np);Xs.error(`Firestore (${To}): ${r}`,...n)}}function lo(r,...e){if(Xs.logLevel<=Oe.WARN){const n=e.map(Np);Xs.warn(`Firestore (${To}): ${r}`,...n)}}function Np(r){if(typeof r=="string")return r;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PR{constructor(){this.changes=new ta((e=>e.toString()),((e,n)=>e.isEqual(n))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,Zt.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const s=this.changes.get(n);return s!==void 0?ee.resolve(s):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class YR{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=(function(){return b4()?8:v3(Jt())>0?6:4})()}initialize(e,n){this.ps=e,this.indexManager=n,this.Rs=!0}getDocumentsMatchingQuery(e,n,s,o){const c={result:null};return this.ys(e,n).next((d=>{c.result=d})).next((()=>{if(!c.result)return this.ws(e,n,o,s).next((d=>{c.result=d}))})).next((()=>{if(c.result)return;const d=new GR;return this.Ss(e,n,d).next((m=>{if(c.result=m,this.Vs)return this.bs(e,n,d,m.size)}))})).next((()=>c.result))}bs(e,n,s,o){return s.documentReadCount<this.fs?(Xa()<=Oe.DEBUG&&he("QueryEngine","SDK will not create cache indexes for query:",Wa(n),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),ee.resolve()):(Xa()<=Oe.DEBUG&&he("QueryEngine","Query:",Wa(n),"scans",s.documentReadCount,"local documents and returns",o,"documents as results."),s.documentReadCount>this.gs*o?(Xa()<=Oe.DEBUG&&he("QueryEngine","The SDK decides to create cache indexes for query:",Wa(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,mi(n))):ee.resolve())}ys(e,n){if(Pv(n))return ee.resolve(null);let s=mi(n);return this.indexManager.getIndexType(e,s).next((o=>o===0?null:(n.limit!==null&&o===1&&(n=Jm(n,null,"F"),s=mi(n)),this.indexManager.getDocumentsMatchingTarget(e,s).next((c=>{const d=Pe(...c);return this.ps.getDocuments(e,d).next((m=>this.indexManager.getMinOffset(e,s).next((g=>{const y=this.Ds(n,m);return this.Cs(n,y,d,g.readTime)?this.ys(e,Jm(n,null,"F")):this.vs(e,y,n,g)}))))})))))}ws(e,n,s,o){return Pv(n)||o.isEqual(xe.min())?ee.resolve(null):this.ps.getDocuments(e,s).next((c=>{const d=this.Ds(n,c);return this.Cs(n,d,s,o)?ee.resolve(null):(Xa()<=Oe.DEBUG&&he("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),Wa(n)),this.vs(e,d,n,f3(o,tc)).next((m=>m)))}))}Ds(e,n){let s=new Nt(rE(e));return n.forEach(((o,c)=>{ed(e,c)&&(s=s.add(c))})),s}Cs(e,n,s,o){if(e.limit===null)return!1;if(s.size!==n.size)return!0;const c=e.limitType==="F"?n.last():n.first();return!!c&&(c.hasPendingWrites||c.version.compareTo(o)>0)}Ss(e,n,s){return Xa()<=Oe.DEBUG&&he("QueryEngine","Using full collection scan to execute query:",Wa(n)),this.ps.getDocumentsMatchingQuery(e,n,Kr.min(),s)}vs(e,n,s,o){return this.ps.getDocumentsMatchingQuery(e,s,o).next((c=>(n.forEach((d=>{c=c.insert(d.key,d)})),c)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class so{static emptySet(e){return new so(e.comparator)}constructor(e){this.comparator=e?(n,s)=>e(n,s)||ge.comparator(n.key,s.key):(n,s)=>ge.comparator(n.key,s.key),this.keyedMap=Bl(),this.sortedSet=new ct(this.comparator)}has(e){return this.keyedMap.get(e)!=null}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const n=this.keyedMap.get(e);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal(((n,s)=>(e(n),!1)))}add(e){const n=this.delete(e.key);return n.copy(n.keyedMap.insert(e.key,e),n.sortedSet.insert(e,null))}delete(e){const n=this.get(e);return n?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(n)):this}isEqual(e){if(!(e instanceof so)||this.size!==e.size)return!1;const n=this.sortedSet.getIterator(),s=e.sortedSet.getIterator();for(;n.hasNext();){const o=n.getNext().key,c=s.getNext().key;if(!o.isEqual(c))return!1}return!0}toString(){const e=[];return this.forEach((n=>{e.push(n.toString())})),e.length===0?"DocumentSet ()":`DocumentSet (
  `+e.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jv{constructor(){this.ga=new ct(ge.comparator)}track(e){const n=e.doc.key,s=this.ga.get(n);s?e.type!==0&&s.type===3?this.ga=this.ga.insert(n,e):e.type===3&&s.type!==1?this.ga=this.ga.insert(n,{type:s.type,doc:e.doc}):e.type===2&&s.type===2?this.ga=this.ga.insert(n,{type:2,doc:e.doc}):e.type===2&&s.type===0?this.ga=this.ga.insert(n,{type:0,doc:e.doc}):e.type===1&&s.type===0?this.ga=this.ga.remove(n):e.type===1&&s.type===2?this.ga=this.ga.insert(n,{type:1,doc:s.doc}):e.type===0&&s.type===1?this.ga=this.ga.insert(n,{type:2,doc:e.doc}):be(63341,{Rt:e,pa:s}):this.ga=this.ga.insert(n,e)}ya(){const e=[];return this.ga.inorderTraversal(((n,s)=>{e.push(s)})),e}}class mo{constructor(e,n,s,o,c,d,m,g,y){this.query=e,this.docs=n,this.oldDocs=s,this.docChanges=o,this.mutatedKeys=c,this.fromCache=d,this.syncStateChanged=m,this.excludesMetadataChanges=g,this.hasCachedResults=y}static fromInitialDocuments(e,n,s,o,c){const d=[];return n.forEach((m=>{d.push({type:0,doc:m})})),new mo(e,n,so.emptySet(n),d,s,o,!0,!1,c)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Jh(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const n=this.docChanges,s=e.docChanges;if(n.length!==s.length)return!1;for(let o=0;o<n.length;o++)if(n[o].type!==s[o].type||!n[o].doc.isEqual(s[o].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gi{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new ue(Z.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new ue(Z.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Me(this._lat,e._lat)||Me(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:gi._jsonSchemaVersion}}static fromJSON(e){if(bc(e,gi._jsonSchema))return new gi(e.latitude,e.longitude)}}gi._jsonSchemaVersion="firestore/geoPoint/1.0",gi._jsonSchema={type:xt("string",gi._jsonSchemaVersion),latitude:xt("number"),longitude:xt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yi{constructor(e){this._values=(e||[]).map((n=>n))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(s,o){if(s.length!==o.length)return!1;for(let c=0;c<s.length;++c)if(s[c]!==o[c])return!1;return!0})(this._values,e._values)}toJSON(){return{type:yi._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(bc(e,yi._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((n=>typeof n=="number")))return new yi(e.vectorValues);throw new ue(Z.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}yi._jsonSchemaVersion="firestore/vectorValue/1.0",yi._jsonSchema={type:xt("string",yi._jsonSchemaVersion),vectorValues:xt("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Js(r){r=Fn(r,ft);const e=Fn(r.firestore,Zs);return X5(eg(e),r._key).then((n=>fb(e,r,n)))}ao._jsonSchemaVersion="firestore/querySnapshot/1.0",ao._jsonSchema={type:xt("string",ao._jsonSchemaVersion),bundleSource:xt("string","QuerySnapshot"),bundleName:xt("string"),bundle:xt("string")};class hb extends cI{constructor(e){super(),this.firestore=e}convertBytes(e){return new Vn(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new ft(this.firestore,null,n)}}function db(r,e,n){r=Fn(r,ft);const s=Fn(r.firestore,Zs),o=ub(r.converter,e,n);return ug(s,[tb(ud(s),"setDoc",r._key,o,r.converter!==null,n).toMutation(r._key,Hn.none())])}function zh(r,e,n,...s){r=Fn(r,ft);const o=Fn(r.firestore,Zs),c=ud(o);let d;return d=typeof(e=Dt(e))=="string"||e instanceof ld?rI(c,"updateDoc",r._key,e,n,s):iI(c,"updateDoc",r._key,e),ug(o,[d.toMutation(r._key,Hn.exists(!0))])}function lg(r,e){const n=Fn(r.firestore,Zs),s=Qn(r),o=ub(r.converter,e);return ug(n,[tb(ud(r.firestore),"addDoc",s._key,o,r.converter!==null,{}).toMutation(s._key,Hn.exists(!1))]).then((()=>s))}function cg(r,...e){r=Dt(r);let n={includeMetadataChanges:!1,source:"default"},s=0;typeof e[s]!="object"||h_(e[s])||(n=e[s++]);const o={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(h_(e[s])){const g=e[s];e[s]=g.next?.bind(g),e[s+1]=g.error?.bind(g),e[s+2]=g.complete?.bind(g)}let c,d,m;if(r instanceof ft)d=Fn(r.firestore,Zs),m=Zh(r._key.path),c={next:g=>{e[s]&&e[s](fb(d,r,g))},error:e[s+1],complete:e[s+2]};else{const g=Fn(r,ia);d=Fn(g.firestore,Zs),m=g._query;const y=new hb(d);c={next:b=>{e[s]&&e[s](new ao(d,y,g,b))},error:e[s+1],complete:e[s+2]},lI(r._query)}return(function(y,b,S,x){const O=new $E(x),U=new zE(b,O,S);return y.asyncQueue.enqueueAndForget((async()=>LE(await cp(y),U))),()=>{O.Nu(),y.asyncQueue.enqueueAndForget((async()=>UE(await cp(y),U)))}})(eg(d),m,o,c)}function ug(r,e){return(function(s,o){const c=new Yr;return s.asyncQueue.enqueueAndForget((async()=>L5(await $5(s),o,c))),c.promise})(eg(r),e)}function fb(r,e,n){const s=n.docs.get(e._key),o=new hb(r);return new Gs(r,o,e._key,s,new Fl(n.hasPendingWrites,n.fromCache),e.converter)}function uc(){return new ng("serverTimestamp")}(function(e,n=!0){(function(o){To=o})(Eo),oo(new Qs("firestore",((s,{instanceIdentifier:o,options:c})=>{const d=s.getProvider("app").getImmediate(),m=new Zs(new r3(s.getProvider("auth-internal")),new o3(d,s.getProvider("app-check-internal")),(function(y,b){if(!Object.prototype.hasOwnProperty.apply(y.options,["projectId"]))throw new ue(Z.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ic(y.options.projectId,b)})(d,o),d);return c={useFetchStreams:n,...c},m._setSettings(c),m}),"PUBLIC").setMultipleInstances(!0)),Hr(pv,gv,e),Hr(pv,gv,"esm2020")})();var hI="firebase",dI="12.1.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
